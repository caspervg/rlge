...
namespace snake {
    ...
    public:
        explicit FpsCounter(rlge::Scene& scene) : RenderEntity(scene) {}
    ...
    public:
        explicit Background(rlge::Scene& scene) : RenderEntity(scene) {}
    ...
    public:
        explicit Scoreboard(rlge::Scene& scene, int& score) : RenderEntity(scene), score_(score) {}
